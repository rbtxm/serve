...
public final class SpringUtils implements BeanFactoryPostProcessor {
    ...
    /**
     * 在Spring上下文中,注册一个新的Bean
     *
     * @return
     */
    public static void registryBean(Object instance) {
        registryBean(instance.getClass().getSimpleName(), instance);
    }
     ...
     * @return
     */
    public static void registryBean(String name, Object instance) {
    ...
    public static <T> List<T> getBeansByClassType(Class<T> clazz) {
        if (clazz == null) {
            return null;
        }
